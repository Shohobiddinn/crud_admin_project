<template>
  <div>
    <addTargetModal @end="get()" ref="target" />
    ...
    <div class="hodimlar">
      <div class="hodimlar_content">
        ...
        >
          ...
          <div class="search d-flex align-items-center">
            <div
              ...
              @click="($refs.target.status = 'target_add'), $refs.target.open()"
            >
              <svg
          ...
          >
            <thead class="border">
              <tr>
                ...
                <th scope="col" class="border">Ko'rishlar Soni</th>
            ...
            <tbody>
              <tr v-for="(item, index) in targets" :key="item?.id">
                ...
                <td class="border">{{ item?.project?.name }}</td>
                <td class="border">{{ item?.count_watches }}</td>
                ...
                <td class="border">
                  ...
                  >
                    ...
                    <div
                      @click="
                        ($refs.target.status = 'target_edit'),
                          $refs.target.open(item)
                      "
        ...
        <div class="items">
          ...
          >
            <div class="card-body">
              ...
              >
                <span>prekt : </span> {{ item?.project?.name }}
              </h5>
              <h5
                class="content_item card-title text-capitalize d-flex justify-content-between align-items-center"
              >
                <span>ko'rishlar soni : </span> {{ item?.count_watches }}
              </h5>
              <h5
                class="content_item card-title text-capitalize d-flex justify-content-between align-items-center"
              >
                <span>razm solish : </span>
                <a :href="item?.link">
                  <button
                    class="card_content_btn text-bg-primary text-uppercase btn"
                  >
        ...
        <DataNotFound v-if="!targets.length" />
      </div>
    </div>
  </div>
</template>
...
import addTargetModal from "../../components/Modal/addTargetModal.vue";
