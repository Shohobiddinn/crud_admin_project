  ...
  <div>
    ...
    <div class="hodimlar">
      <div class="hodimlar_content">
        ...
        >
          <div class="hodimlar_content_top_title text-uppercase">
            media fayllar
          </div>
          <div class="search d-flex align-items-center col-4">
            ...
            <div
              ...
              @click="($refs.file.status = 'file_add'), $refs.file.open()"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="25"
          ...
          >
            ...
            <tbody>
              <tr v-for="item in fileData" :key="item?.id">
                <th class="border" scope="row">{{ item?.source_id }}</th>
                <td class="border">{{ item?.file }}</td>
        ...
        <DataNotFound v-if="!fileData.length" />
      </div>
    </div>
  </div>
</template>
