  ...
  <div>
    ...
    <div class="hodimlar">
      <div class="hodimlar_content">
        ...
        >
          <div class="hodimlar_content_top_title text-uppercase">itemlar</div>
          <div class="search d-flex align-items-center">
            <div
              class="hodimlar_content_top_add text-bg-success"
              @click="
                ($refs.categoryItem.status = 'category_item_add'),
                  ($refs.categoryItem.category_id = params.id),
        ...
        <div class="tables" v-if="categoryItem?.category_items?.length">
          <table
          ...
          >
            <thead class="border">
              <tr>
                ...
                <th scope="col" class="border">Malumotlar</th>
            ...
            <tbody>
              <tr
                v-for="item in categoryItem?.category_items"
                :key="item?.id"
              >
                <th class="border" scope="row">{{ categoryItem?.id }}</th>
        ...
        <DataNotFound v-if="!categoryItem?.category_items?.length" />
      </div>
    </div>
  </div>
</template>
